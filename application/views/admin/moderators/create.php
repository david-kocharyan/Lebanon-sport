	...
	<div class="white-box">
		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">
				...
				<form action="<?= base_url('admin/moderators/store') ?>" method="post" enctype="multipart/form-data">
					<div class="form-body">
							...
							<div class="col-md-12 ">
								<div class="form-group">
									...
									<input type="text" id="first_name" class="form-control" name="first_name"
										   value="<?= $this->input->post("first_name"); ?>" style="direction: ltr">
								</div>
							</div>
						</div>
							...
							<div class="col-md-12 ">
								<div class="form-group">
									...
									<input type="text" id="last_name" class="form-control" name="last_name"
										   value="<?= $this->input->post("last_name"); ?>" style="direction: ltr">
								</div>
							</div>
						</div>
							...
							<div class="col-md-12 ">
								<div class="form-group">
									...
									<input type="text" id="password" class="form-control" name="password"
										   style="direction: ltr" value="<?= $this->input->post("password"); ?>">
