<div class="col-md-12 col-sm-12">
	<div class="white-box">
		<h3 class="box-title m-b-0">Edit Coaches</h3>

		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">

				<form action="<?= base_url('admin/coaches/update/') . $coaches->id ?>" method="post"
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" id="lastName" class="form-control" name="name_ar"
										   value="<?= $coaches->name_ar; ?>" style="direction: rtl">
								</div>
							</div>
						</div>
					</div>
							...
							<div class="form-group">
								...
								<select name="school" id="school" class="form-control">
									<?php foreach ($schools as $key) { ?>
										<option value="<?= $key->id ?>" <?php if ($key->id == $coaches->school_id) { ?>
											selected
